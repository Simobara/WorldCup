...
export const CssGs = {
  ...
  BorderLineNextMatch:  "border-b-2 border-[var(--gs-border-line-next-match)] border-dashed",

  pinWin:               "text-[var(--pin-win)] text-sm ",
  pinDraw:              "text-[var(--pin-draw)] text-sm ",
  pinLose:              "text-[var(--pin-lose)] text-sm ",

  colBgDayWeek:         "bg-[var(--gs-col-bg-day-week)] !text-[var(--gs-col-text-day-week)]",
  colBgDaySab:          "bg-[var(--gs-col-bg-day-sab)] !text-[var(--gs-col-text-day-sab)]",
  colBgDayDom:          "bg-[var(--gs-col-bg-day-dom)] !text-[var(--gs-col-text-day-dom)]",
};
...
export const CssTs = {
  ...
  ATeamBg:              "text-black bg-[var(--ts-a-team-bg)] border-t-0 border-l-4 border-[var(--ts-a-team-border)] rounded-t-sm rounded-l-3xl rounded-tr-xl",
  ATeamBgSolid:         "text-black bg-[rgb(var(--ts-a-team-bg-rgb))] border-t-0 border-l-4 border-[var(--ts-a-team-border)] rounded-t-sm rounded-l-3xl rounded-tr-xl",
  ...
  NTeamBg:              "bg-[var(--ts-n-team-bg)] border-b-0 border-l-4 border-[var(--ts-n-team-border)] rounded-t-sm rounded-tl-2xl rounded-br-xl",
  NTeamBgSolid:         "bg-[rgb(var(--ts-n-team-bg-rgb))] border-b-0 border-l-4 border-[var(--ts-n-team-border)] rounded-t-sm rounded-tl-2xl rounded-br-xl",
